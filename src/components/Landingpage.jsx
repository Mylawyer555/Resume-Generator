...
const LandingPage = () => {
  ...
  return (
    <div className="bg-white font-sans text-gray-800 antialiased"> {/* Added antialiased for smoother fonts */}
      ...
      <section className="relative flex flex-col md:flex-row items-center px-6 md:px-16 py-16 md:py-24 bg-blue-100 overflow-hidden">
      ...
      <section className="bg-gray-50 py-16 md:py-24 px-6 md:px-16 flex flex-col  gap-12"> {/* Added gap for spacing */}
      ...
      <section className="h-[400px] mb-[150px] px-14 py-6 w-full md:flex md:gap-5">
        <div className="md:w-1/2 mb-12 md:mb-0 md:text-left md:flex gap-12">
          ...
          <ul className="space-y-5 text-gray-700 mb-10 text-lg"> {/* Increased spacing and text size */}
            ...
            <button
            onClick={handleStartBuilding}
            className="bg-yellow-500 hover:bg-yellow-600 inline-block text-white px-8 py-4 rounded-lg font-semibold text-lg shadow-md hover:shadow-lg transition transform hover:-translate-y-1"
          >
